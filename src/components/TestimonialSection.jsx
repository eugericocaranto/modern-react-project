...
const TestimonialSection = () => {
  const testimonials = [
    ...
    },
    {
      ...
      text: "When she reached the first hills of the Mountains, she had a last view back on the of her hometown Bookmarksgrove, the headline. Lorem Ipsum comes from sections.",
    },
    {
      id: 4,
      name: "Sarah Johnson",
