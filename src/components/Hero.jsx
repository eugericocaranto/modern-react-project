    ...
    <section id="home" className='container mx-auto flex flex-col md:flex-row justify-between pt-44 pb-6 px-4 sm:px-6 lg:px-8'>
      ...
      <div className='w-full md:w-1/2 space-y-8'>
        ...
        <div className='flex gap-3 max-w-md'>
          <input type="email" placeholder='Email adress' className='flex-1 px-6 py-4 border border-gray-200
      ...
      <div className='w-full md:w-1/2 mt-16 md:mt-0 pl-0 md:pl-12'>
        <div className='relative'>
          <img src={heroImage} alt="hero" className='rounded-lg relative z-10 hover:scale-[1.02]
